...
HTTPResponse::HTTPResponse() : 
                    _mime(), _location(), _server(NULL), _serverConfig(NULL)
{

}

Response::Response(const Response &src) : 
        _request(src._request), _full_path(src._full_path), 
        _body(src._body), _redirectCode(src._redirectCode), _redirectUrl(src._redirectUrl), 
        _cgiFlag(src._cgiFlag), _contentLength(src._contentLength), _autoindex(src._autoindex)
{
